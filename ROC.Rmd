...
mycol <- c("slateblue","seagreen3","dodgerblue","firebrick1","lightgoldenrod","magenta","orange2","gold","firebrick4","deepskyblue1","deeppink3","coral2","chocolate")

pdf("ROC3.pdf",height=6,width=6)
auc.out <- c()
...
write.table(p.out,"pvalue_output2.xls",sep="\t",quote=F,row.names = F,col.names = T)
...
write.table(auc.out,"auc_output2.xls",sep="\t",quote = F,row.names = F,col.names = T)
